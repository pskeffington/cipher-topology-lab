...
- Project version: `0.4.1-pre.0-32rep`
...
- Command: `/Users/null/Documents/GitHub/cipher-topology-lab/.venv/bin/python scripts/08_validate_artifact_coherence.py --config configs/experiment_32rep.json`
- Status: `PASS`

```text
Validated artifact coherence: conditions=6, embeddings=2, homology_dims=[0, 1], replicates=32, baseline=sha256_seeded_baseline.
```
...
| Path | Status | Rows |
| --- | --- | --- |
| `data/raw/stream_manifest.csv` | present | 192 |
| `data/interim/embedding_manifest.csv` | present | 384 |
| `data/processed/tda_features.csv` | present | 768 |
| `data/processed/randomness_tests_internal.csv` | present | 192 |
...
| `results/tables/tda_distance_to_sha256_seeded_baseline.csv` | present | 768 |
