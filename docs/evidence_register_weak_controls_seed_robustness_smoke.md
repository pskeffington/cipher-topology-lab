...
Generated: `2026-06-25T20:52:09+00:00`

## Configuration

- Config: `configs/experiment_weak_controls_seed_robustness_smoke.json`
- Project version: `0.4.1-pre.0-weak-controls-seed-robustness-smoke`
...
- Command: `/Users/null/GitHub/cipher-topology-lab/.venv/bin/python scripts/08_validate_artifact_coherence.py --config configs/experiment_weak_controls_seed_robustness_smoke.json`
- Status: `PASS`

```text
Validated artifact coherence: conditions=8, embeddings=2, homology_dims=[0, 1], replicates=2, baseline=sha256_seeded_baseline.
```
...
| Path | Status | Rows |
| --- | --- | --- |
| `data/raw/stream_manifest.csv` | present | 16 |
| `data/interim/embedding_manifest.csv` | present | 32 |
| `data/processed/tda_features.csv` | present | 64 |
| `data/processed/randomness_tests_internal.csv` | present | 16 |
...
| `results/tables/tda_distance_to_sha256_seeded_baseline.csv` | present | 64 |
